...
def write_group_ids_and_sequences(ctg_group_dict, list_unreassigned_unitig, fa_dict):
    ...
    group_ids = {'chr01_group1': [], 'chr01_group2': [], 'chr01_group3': [], 'chr01_group4': [], 'chr02_group1': [], 'chr02_group2': [], 'chr02_group3': [], 'chr02_group4': [], 'chr03_group1': [], 'chr03_group2': [], 'chr03_group3': [], 'chr03_group4': [], 'chr04_group1': [], 'chr04_group2': [], 'chr04_group3': [], 'chr04_group4': [], 'chr05_group1': [], 'chr05_group2': [], 'chr05_group3': [], 'chr05_group4': [], 'chr06_group1': [], 'chr06_group2': [], 'chr06_group3': [], 'chr06_group4': [], 'chr07_group1': [], 'chr07_group2': [], 'chr07_group3': [], 'chr07_group4': [], 'chr08_group1': [], 'chr08_group2': [], 'chr08_group3': [], 'chr08_group4': [], 'chr09_group1': [], 'chr09_group2': [], 'chr09_group3': [], 'chr09_group4': [], 'chr10_group1': [], 'chr10_group2': [], 'chr10_group3': [], 'chr10_group4': [], 'chr11_group1': [], 'chr11_group2': [], 'chr11_group3': [], 'chr11_group4': [], 'chr12_group1': [], 'chr12_group2': [], 'chr12_group3': [], 'chr12_group4': []}
    group_seqs = {'chr01_group1': [], 'chr01_group2': [], 'chr01_group3': [], 'chr01_group4': [], 'chr02_group1': [], 'chr02_group2': [], 'chr02_group3': [], 'chr02_group4': [], 'chr03_group1': [], 'chr03_group2': [], 'chr03_group3': [], 'chr03_group4': [], 'chr04_group1': [], 'chr04_group2': [], 'chr04_group3': [], 'chr04_group4': [], 'chr05_group1': [], 'chr05_group2': [], 'chr05_group3': [], 'chr05_group4': [], 'chr06_group1': [], 'chr06_group2': [], 'chr06_group3': [], 'chr06_group4': [], 'chr07_group1': [], 'chr07_group2': [], 'chr07_group3': [], 'chr07_group4': [], 'chr08_group1': [], 'chr08_group2': [], 'chr08_group3': [], 'chr08_group4': [], 'chr09_group1': [], 'chr09_group2': [], 'chr09_group3': [], 'chr09_group4': [], 'chr10_group1': [], 'chr10_group2': [], 'chr10_group3': [], 'chr10_group4': [], 'chr11_group1': [], 'chr11_group2': [], 'chr11_group3': [], 'chr11_group4': [], 'chr12_group1': [], 'chr12_group2': [], 'chr12_group3': [], 'chr12_group4': []}
    ...
    for ctg, groups in ctg_group_dict.items():
        ...
        for group in groups:
            ...
            group_ids[group].append(ctg)
            group_seqs[group].append(f'>{ctg}\n{fa_dict[ctg][0]}')
            combined_seqs.append(f'>{group}_{ctg}\n{fa_dict[ctg][0]}')
            print(f'Debugs: {ctg} is added to group {group}')
...
def parse_arguments():
    ...
    parser.add_argument('--draft_fasta', required=True, help='draft fasta file, e.g., p_utg fasta from hifiasm')
...
def main():
    ...
    candidate_sequences, _, _ = read_fasta_with_re_sites(args.fasta, args.RE)
    ...
    unitig_ids = sorted(
        candidate_sequences,
        key=lambda unitig: (-lengths[unitig], unitig),
    )
    ...
    new_memberships = write_recluster_outputs(
        ...
        restriction_sites,
        declared_groups,
        output_group_id=lambda group_id: group_id,
    )
